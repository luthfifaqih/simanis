...
@section('dashboard')
    ...
    <div style="display: flex; justify-content: center;">
        <a href="#kt_content" class="card hover-elevate-up shadow-sm parent-hover"
            style="width: 400px; height: 100px; margin: 10px; display: flex; align-items: center;" data-bs-toggle="tab">
            <div class="card-body d-flex align-items-center" style="padding: 0;">
                <span class="svg-icon fs-1">
                    ...
                </span>

                <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold" style="margin-left: 10px;">
                    Detail Permohonan
                </span>
            </div>
        </a>
        <a href="#kt_content_2" class="card hover-elevate-up shadow-sm parent-hover"
            style="width: 400px; height: 100px; margin: 10px; display: flex; align-items: center;" data-bs-toggle="tab">
            <div class="card-body d-flex align-items-center" style="padding: 0;">
                <span class="svg-icon fs-1">
                    ...
    ...
    {{-- riwayat konten --}}
    <div class="content d-flex flex-column flex-column-fluid tab-pane fade" id="kt_content_2" role="tabpanel">
    ...
    <!--begin::Content-->
    <div class="tab-content content d-flex flex-column flex-column-fluid tab-pane fade show active" id="kt_content"
        role="tabpanel">
        <div class="post d-flex flex-column-fluid" id="kt_post" role="tabpanel">
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
